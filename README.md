...
When you need to express more than 140 charaters worth, but don't want to write a blog post.


# Getting Started
[Web Starter Kit](https://developers.google.com/web/tools/starter-kit/)
[Install Guide] (https://github.com/google/web-starter-kit/blob/master/docs/install.md)
